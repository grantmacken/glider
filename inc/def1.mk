...
function _:erewhon($$ITEM){
  ...
  return
    ...
    _:svrErr(
		map { 'uri': 'http://' || '$(DEV_DOMAIN):$($(DEV_PORT))/' || $$ITEM, 
...
The source for this page is a markdown document located in `src/data/$(DEV_DOMAIN)/index.md`
...
The layout source is `src/data/$(DEV_DOMAIN)/default_layout.xq`
